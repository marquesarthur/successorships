...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.75\linewidth]{state-convergence-payload-size}
%     \caption{State convergence as a function of the operation payload}
%     \label{fig:state-convergence-payload-size}
% \end{figure}